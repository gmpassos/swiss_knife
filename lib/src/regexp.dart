...
RegExp regExpDialect( Map<String,String> dialectWords , String pattern , { bool multiLine = false, bool caseSensitive = true}) {
  for (var i = 0 ; i < 10 ; i++) {
    var words2 = dialectWords.map((k, v) => MapEntry(k, _regExpDialectImpl(dialectWords, v).pattern));
